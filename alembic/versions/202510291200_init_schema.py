...
def upgrade() -> None:
    ...
    op.create_table(
        "briefs",
        sa.Column("id", sa.String(length=64), primary_key=True),
        sa.Column("profile_id", sa.String(length=64), sa.ForeignKey("profiles.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("brief_id", sa.String(length=64), sa.ForeignKey("briefs.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_index("ix_brief_actions_brief_id", "brief_actions", ["brief_id"], unique=False)
    ...
    op.create_index("ix_brief_signals_brief_id", "brief_signals", ["brief_id"], unique=False)
    ...
    op.create_index("ix_draft_reports_brief_id", "draft_reports", ["brief_id"], unique=False)

    op.create_table(
        "refined_reports",
        sa.Column("id", sa.String(length=64), primary_key=True),
        sa.Column("draft_id", sa.String(length=64), sa.ForeignKey("draft_reports.id", ondelete="CASCADE"), nullable=False, unique=True),
        sa.Column("content", sa.Text(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    )
    ...
    op.create_index("ix_interactions_received_at", "interactions", ["received_at"], unique=False)
