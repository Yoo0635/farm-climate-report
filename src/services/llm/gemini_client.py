...
class GeminiRefiner:
    ...
    def build_prompt(self, detailed_report: str) -> str:
        ...
        return (
            "당신은 농업 전문가로서, 이 보고서 내용을 현장의 농업인에게 전달하려고 합니다. 아래 보고서를 분석해서, 농장주가 향후 2주간 가장 시급하게 대응해야 할 사항을 중심으로 요약해 주세요.\n"
            "조건:\n"
            f"- 대상: 농사일로 바쁜 농장주가 쉽게 이해할 수 있도록 작성\n"
            "- 형식: 가장 중요한 순서대로 번호를 매겨 목록으로 정리, 본문만, 마크다운 없이 작성\n"
            "- 내용: 각 항목에 '무엇을(What)', '언제(When)', '왜(Why)' 해야 하는지 한 문단으로, 간략하게 작성\n"
